...
class Polynomial {
    ...
    Polynomial() {           // Default constructor
		degCoeff = new int[10];
         for(int i=0;i<10;i++)  // Initializing array with 0
             degCoeff[i]=0;
		capacity = 10;
	}

	 Polynomial(const Polynomial &d) {              //  Copy constructor
   ...
   void setCoefficient(int deg,int coeff) {     // setCoefficient
          if(deg>=capacity)
          {
             int size=deg+1;
    ...
    Polynomial operator+(Polynomial &p) {     //  Overload "+" operator
        Polynomial newP;
    ...
    Polynomial operator*(Polynomial const &p) {      //  Overload * operator 
        Polynomial newP;
    ...
    Polynomial operator=(Polynomial const &d) {      //  Overload "=" operator
		this -> degCoeff = new int[d.capacity];
		for(int i = 0; i < d.capacity; i++) {
			this -> degCoeff[i] = d.degCoeff[i];
		}
