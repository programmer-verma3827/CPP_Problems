...
// int printSubset(int *arr, int n, int k)
// {
//     if(n == 0)
//     {
//         if(k == 0)
...
//     int result1 = printSubset(arr, n-1, k-arr[n-1]);
//     int result2 = printSubset(arr, n-1, k);
...
int subsetCount(int *arr, int n, int index, int target)
{
    ...
    {
        count = count + subsetCount(arr, n, index + 1, target - arr[index]);
    }
    
    count = count + subsetCount(arr, n, index + 1, target);
    return count;
}
